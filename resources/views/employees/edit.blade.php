                        ...
                        <form action="{{ route('employees.update', ['employee' => $employee->id]) }}" method="POST"
                            ...
                            <div class="d-flex flex-column flex-md-row mb-3 gap-3">
                                <div class="w-100">
                                    ...
                                    <input type="text" class="form-control @error('nik') is-invalid @enderror"
                                        id="nik" name="nik" value="{{ old('nik', $employee->nik) }}"
                                ...
                                <div class="w-100">
                                    ...
                                    <input type="text" class="form-control @error('nama') is-invalid @enderror"
                                        id="nama" name="nama" value="{{ old('nama', $employee->nama) }}"
                            ...
                            <div class="d-flex flex-column flex-md-row mb-3 gap-3">
                                <div class="w-100">
                                    ...
                                    <input type="text" class="form-control @error('jabatan') is-invalid @enderror"
                                        id="jabatan" name="jabatan" value="{{ old('jabatan', $employee->jabatan) }}"
                            ...
                            <div class="d-flex flex-column flex-md-row mb-3 gap-3">
                                <div class="w-100">
                                    ...
                                    <input type="number" class="form-control @error('gaji') is-invalid @enderror"
                                        id="gaji" name="gaji" value="{{ old('gaji', $employee->gaji) }}"
                                        required>
                                    @error('gaji')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="mb-3">
                                ...
                                <input type="file" class="form-control @error('foto') is-invalid @enderror"
                                    id="foto" accept=".jpg, .jpeg, .png" name="foto">
                                @error('foto')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
